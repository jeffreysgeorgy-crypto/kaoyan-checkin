...
# 真实课表（用户提供，周二已纠正为下午课；周四去 p2、周五加 p2）：weekday -> [(start, end, weeks)]
def _weeks(spec):
    out = set()
...
SCHEDULE = {
    ...
    4: [("08:00", "09:40", _weeks("1-16")), ("14:30", "16:10", _weeks("5-16")), ("16:20", "18:00", _weeks("3,5,7,9,11,13,15-16"))],  # 周四
    5: [("10:10", "11:50", _weeks("13-16")), ("14:30", "16:10", _weeks("8-15"))],                                      # 周五
    6: [],                                                                                                            # 周六
    7: [],                                                                                                            # 周日
}
...
COURSE_NOTE = {
    ...
    4: {1: "优化方法", 3: "实验课", 4: "实验课"},
    5: {2: "数字图像处理", 3: "单片机及接口技术"},
}
...
def main():
    ...
    print("   注意：还需单独更新 data.js 顶部的 SCHEDULE（周四去 p2、周五加 p2）。")
